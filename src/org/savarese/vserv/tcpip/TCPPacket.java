...
public class TCPPacket extends IPPacket implements Serializable {
    ...
    public static final int MASK_CWR = 0x80;
    public static final int MASK_ECE = 0x40;
    public static final int MASK_RESERVED_1 = 0x8;
    public static final int MASK_RESERVED_2 = 0x4;
    public static final int MASK_RESERVED_3 = 0x2;
    public static final int MASK_RESERVED_4 = 0x1;
    ...
    public void setReservedBits4(int mask) {
        _data_[__offset + OFFSET_HEADER_LENGTH] &= 0xf0;
        _data_[__offset + OFFSET_HEADER_LENGTH] |= (mask & 0x0f);
    }

    public int getReservedBits4() {
        return (_data_[__offset + OFFSET_HEADER_LENGTH] & 0x0f);
    }
    ...
    public byte getControlFlags() {
        return _data_[__offset + OFFSET_CONTROL];
    }
    ...
    public final int computeTCPChecksum(boolean update, int checkSum) {
        return _computeChecksum_(__offset, __offset + OFFSET_TCP_CHECKSUM,
                getIPPacketLength(), __getVirtualHeaderTotal(),
                update, checkSum);
    }
    ...
    public void setTCPCheckSum(int checkSum) {
        computeTCPChecksum(true, checkSum);
    }
